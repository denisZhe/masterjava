...
//            http://docs.oracle.com/javaee/6/tutorial/doc/glraq.html
            ...
            if (chunkSize < 1) {
                ...
                try (InputStream cityIs = filePart.getInputStream()){
                    cityProcessor.process(cityIs);
                }
                try (InputStream usersIs = filePart.getInputStream()) {
                    List<UserProcessor.FailedEmails> failed = userProcessor.process(usersIs, chunkSize);
